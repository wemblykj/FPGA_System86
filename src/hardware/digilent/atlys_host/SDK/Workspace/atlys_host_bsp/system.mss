...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ttlmembus
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = axi_rom_3s
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ttlmembus
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = axi_rom_9c
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ttlmembus
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = axi_rom_9d
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ttlmembus
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = axi_rom_12d
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = ttlmembus
 PARAMETER DRIVER_VER = 1.00.a
 PARAMETER HW_INSTANCE = axi_rom_12c
END
