...
module mb111_a02_and2_tb;
	...
	initial begin
		...
		write_header("CUS27 2-input AND");
		
		apply_test("test 1", /*A=*/1'b0, /*B=*/1'b0, /*Y_exp=*/1'b0, test_result);
		apply_test("test 2", /*A=*/1'b0, /*B=*/1'b1, /*Y_exp=*/1'b0, test_result);
		apply_test("test 3", /*A=*/1'b1, /*B=*/1'b0, /*Y_exp=*/1'b0, test_result);
		apply_test("test 4", /*A=*/1'b1, /*B=*/1'b1, /*Y_exp=*/1'b1, test_result);
