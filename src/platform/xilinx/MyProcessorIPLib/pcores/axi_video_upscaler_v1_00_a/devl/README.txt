...
Peripheral Summary:
  ...
  XPS project / EDK repository               : /home/administrator/Development/fpga/system86/src/platform/xilinx/MyProcessorIPLib
  logical library name                       : axi_video_upscaler_v1_00_a
  top name                                   : axi_video_upscaler
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- HDL source file(s)
  ...
  hdl/vhdl/axi_video_upscaler.vhd
...
- XPS interface file(s)
  ...
  data/axi_video_upscaler_v2_1_0.mpd
  ...
  data/axi_video_upscaler_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/axi_video_upscaler.xise
...
- XST synthesis file(s)
  ...
  devl/synthesis/axi_video_upscaler_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/axi_video_upscaler_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/axi_video_upscaler_v2_1_0.tcl
