------------------------------------------------------------------------------
-- signal_inverter.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
-------------------------------------------------------------------------------
-- signal_inverter_v1_00_a library is used for signal_inverter component declarations
-------------------------------------------------------------------------------

library signal_inverter_v1_00_a;
...
entity signal_inverter is
  generic (
	C_BUS_WIDTH : integer range 1 to 3 := 3;
	
	--Family Generics
	C_XLNX_REF_BOARD : string := "NONE";
	C_FAMILY : string := "virtex6";
	C_INSTANCE : string := "signal_inverter_inst"
  );
  port (
	A		: in srd_logic_vector((C_BUS_WIDTH - 1) downto 0);
  ...
  attribute IP_GROUP of signal_inverter : entity is "LOGICORE";
  attribute SIGIS : string;

end entity signal_inverter;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of signal_inverter is
...
function str(slv: std_logic_vector) return string is
  ...
  constant C_CORE_GENERATION_INFO : string := C_INSTANCE & ",signal_inverter,{"
    & "C_FAMILY = "              &  C_FAMILY
